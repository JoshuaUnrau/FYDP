...
class Position_Controller:
    ...
    def transform_rotated_point(self,point, x, y, angle):
        point.linear.x = point.linear.x + x * math.cos(angle)
        point.linear.y = point.linear.y + y * math.sin(angle)
        return point
    ...
    def set_table_pose(self, data):
        ...
        position_8 = Twist()
        position_8 = self.transform_rotated_point(self.table_pose,
                                                  -self.SAFE_GRIPPING_DIST,
                                                  -self.TABLE_WIDTH / 2,
                                                  angle)
